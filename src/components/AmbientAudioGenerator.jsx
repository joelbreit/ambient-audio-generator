            ...
            if (active) {
                ...
                const animate = () => {
                    ...
                    particles.forEach((particle) => {
                        ...
                        const pulse =
                            1 + Math.sin(time * particle.pulseSpeed) * 0.5;
                        const size =
                            particle.size * pulse * (isPlaying ? 1.5 : 0.8);
                        ...
                        glow.addColorStop(
                            0,
                            particle.color.replace(")", ", 0.8)")
                        );
                        glow.addColorStop(
                            1,
                            particle.color.replace(")", ", 0)")
                        );
                        ctx.fillStyle = glow;
                        ctx.fill();
                    });
            ...
            <div className="bg-slate-900 bg-opacity-20 rounded-lg shadow-lg p-6 max-w-md w-full">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-xs text-center mt-2 text-slate-300 italic">
                        *On mobile devices, you may need to unmute your
                        ringer/silent switch in order to hear the audio
                    </p>
                </div>
                ...
                <div className="space-y-4 mb-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <input
                            ...
                            value={audioColor}
                            onChange={(e) =>
                                setAudioColor(parseFloat(e.target.value))
                            }
                            className="flex-1"
                        />
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <input
                            ...
                            value={bassLevel}
                            onChange={(e) =>
                                setBassLevel(parseFloat(e.target.value))
                            }
                            className="flex-1"
                        />
                    </div>
